...
with st.sidebar:
    ...
    st.write("📧 abc@gmail.com")
    st.write(" +91-9999999999")
    ...
    with col2:
        ...
        st.write("Instagram")
    with col3:
        st.markdown("[![X](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/X_logo.jpg/960px-X_logo.jpg)](https://X.com)")
        st.write("X")
...
with tab2:
    ...
    st.write("During my 10th grade at Bhashyam Blooms, I was still exploring my interests and had not yet discovered my passion for technology or programming. It was a phase where I was learning about myself and gradually understanding the importance of focus, discipline, and future goals.")
    st.divider()
    st.subheader("🎓 11th Grade — Resonance Global Campus")
    st.write("By the time I entered 11th grade at Resonance Global Campus, my mindset had changed significantly. I became more focused on academics, personal growth, and my future career. I started aiming to pursue my undergraduate studies abroad and began working harder toward my goals. During this period, I also developed a strong interest in Python programming, technology, and building projects.")
    st.divider()
    st.subheader("🎓 12th Grade — Resonance Global Campus")
    st.write("Currently pursuing my 12th grade at Resonance Global Campus, I continue to stay focused on both academics and skill development. Alongside preparing for international undergraduate opportunities, I have also been preparing for the JEE examination as a backup plan. At the same time, I actively work on improving my coding skills, building Streamlit projects, and learning modern technologies to grow as a future software developer.")
    st.divider()
